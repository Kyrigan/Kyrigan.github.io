...
type Shape = Inked Color (Maybe (LineType, Color)) Stencil
           | Move (Float,Float) Shape
           | Rotate Float Shape
           | ScaleXY Float Float Shape
           | Group (List Shape)
...
makeTransparent: Float -> Shape -> Shape
